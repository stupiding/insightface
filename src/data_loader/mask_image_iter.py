...
class FaceImageIter(io.DataIter):
    def __init__(self, batch_size, data_shape,
        ...
        #self.provide_data = [(data_names[0], (batch_size * 2, 512, 7, 7))]
        self.provide_data = [(data_names[0] + '_orig', (batch_size, 512, 7, 7)),
                             (data_names[0] + '_mask', (batch_size, 512, 7, 7)), 
                             (data_names[1] + '_orig', (batch_size, 512)), 
                             (data_names[1] + '_mask', (batch_size, 512))]
        #self.provide_data = [(data_names[0], (batch_size, 512, 7, 7))]
...
if __name__ == '__main__':
  import config
  from train_softmax_mask import get_module

  from utils.parser import parse_args
  args = parse_args()
  args.pretrained = '../models/emore-model-r100-softmax1e3/model,38'
